...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> BLOCO_ESSENCIA_INFINITA = BLOCKS.register("bloco_essencia_infinita",
            () -> new Block(Block.Properties.of().mapColor(MapColor.COLOR_LIGHT_GRAY).strength(5.0f, 6.0f).sound(SoundType.METAL).lightLevel(state -> 15)));
    ...
    public static final RegistryObject<Block> BAU_INFINITO_T5 = BLOCKS.register("bau_infinito_t5",
            () -> new Block(Block.Properties.of().mapColor(MapColor.COLOR_PURPLE).strength(5.0f, 10.0f).sound(SoundType.METAL).lightLevel(state -> 5)));

    // ===== GERADORES DE ENERGIA =====
    public static final RegistryObject<Block> GERADOR_BASICO = BLOCKS.register("gerador_basico",
            () -> new Block(Block.Properties.of().mapColor(MapColor.COLOR_RED).strength(3.0f, 6.0f).sound(SoundType.METAL).lightLevel(state -> 8)));

    public static final RegistryObject<Block> GERADOR_ELEMENTAR = BLOCKS.register("gerador_elementar",
            () -> new Block(Block.Properties.of().mapColor(MapColor.COLOR_ORANGE).strength(4.0f, 8.0f).sound(SoundType.METAL).lightLevel(state -> 10)));

    public static final RegistryObject<Block> GERADOR_SUPERIOR = BLOCKS.register("gerador_superior",
            () -> new Block(Block.Properties.of().mapColor(MapColor.COLOR_YELLOW).strength(5.0f, 10.0f).sound(SoundType.METAL).lightLevel(state -> 12)));

    public static final RegistryObject<Block> GERADOR_INFINITO = BLOCKS.register("gerador_infinito",
            () -> new Block(Block.Properties.of().mapColor(MapColor.COLOR_LIGHT_GRAY).strength(6.0f, 12.0f).sound(SoundType.METAL).lightLevel(state -> 15)));

    // ===== REATORES NUCLEARES =====
    public static final RegistryObject<Block> REATOR_FISSAO = BLOCKS.register("reator_fissao",
            () -> new Block(Block.Properties.of().mapColor(MapColor.COLOR_RED).strength(5.0f, 10.0f).sound(SoundType.METAL).lightLevel(state -> 10)));

    public static final RegistryObject<Block> REATOR_FUSAO = BLOCKS.register("reator_fusao",
            () -> new Block(Block.Properties.of().mapColor(MapColor.COLOR_CYAN).strength(6.0f, 12.0f).sound(SoundType.METAL).lightLevel(state -> 12)));

    public static final RegistryObject<Block> REATOR_TERMOCLEAR = BLOCKS.register("reator_termoclear",
            () -> new Block(Block.Properties.of().mapColor(MapColor.COLOR_PURPLE).strength(7.0f, 15.0f).sound(SoundType.METAL).lightLevel(state -> 14)));

    public static final RegistryObject<Block> REATOR_HIBRIDO = BLOCKS.register("reator_hibrido",
            () -> new Block(Block.Properties.of().mapColor(MapColor.COLOR_LIGHT_GRAY).strength(8.0f, 20.0f).sound(SoundType.METAL).lightLevel(state -> 15)));

    // ===== BLOCOS DE PROCESSAMENTO =====
    public static final RegistryObject<Block> PROCESSADOR_TIER1 = BLOCKS.register("processador_tier1",
            () -> new Block(Block.Properties.of().mapColor(MapColor.COLOR_BLUE).strength(3.0f, 6.0f).sound(SoundType.METAL).lightLevel(state -> 7)));

    public static final RegistryObject<Block> PROCESSADOR_TIER5 = BLOCKS.register("processador_tier5",
            () -> new Block(Block.Properties.of().mapColor(MapColor.COLOR_LIGHT_GRAY).strength(5.0f, 10.0f).sound(SoundType.METAL).lightLevel(state -> 10)));

    // ===== BLOCOS DECORATIVOS =====
    public static final RegistryObject<Block> BLOCO_ENERGETICO = BLOCKS.register("bloco_energetico",
            () -> new Block(Block.Properties.of().mapColor(MapColor.COLOR_PURPLE).strength(2.5f, 5.0f).sound(SoundType.METAL).lightLevel(state -> 10)));
